        ...
        <main className="homepage">
            ...
            <section className="shop-by-categories">
                ...
                <div className="categories-container" ref={categoryRef}>
                    <Link href='/shop/men' className="container men">
                    ...
                    <Link href='/shop/women' className="container women">
                    ...
                    <Link href='/shop/footwear' className="container footwear">
                    ...
                    <Link href='/shop/wristwatch' className="container wrist-watch">
